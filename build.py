...
def main(argv):
    ...
    try:
        ...
        print 'build.py -i <inputfile> -o <outputfile>'
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
